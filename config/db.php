...
return [
    'comics' => array(
        [
            ...
            "thumb" => "resources/img/comic1.jpg",
            "price" => "$19.99",
        ...
        [
            ...
            "thumb" => "resources/img/comic2.jpg",
            "price" => "$3.99",
        ...
        [
            ...
            "thumb" => "resources/img/comic4.jpg",
            "price" => "$2.99",
            "series" => "Batgirl",
        ...
        [
            ...
            "thumb" => "resources/img/comic5.jpg",
            "price" => "$3.99",
            "series" => "Batman",
        ...
        [
            ...
            "thumb" => "resources/img/comic10.jpg",
            "price" => "$6.99",
        ...
        [
            ...
            "thumb" => "resources/img/comic11.jpg",
            "price" => "$4.99",
